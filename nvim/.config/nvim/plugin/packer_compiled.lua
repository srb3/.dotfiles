...
_G.packer_plugins = {
  ...
  ["fzf.vim"] = {
    ...
    loaded = true,
    path = "/home/michael/.config/local/share/nvim/site/pack/packer/start/fzf.vim"
  },
  ["gv.vim"] = {
    loaded = true,
    path = "/home/michael/.config/local/share/nvim/site/pack/packer/start/gv.vim"
  },
  ["nvim-colorizer.lua"] = {
    loaded = true,
  ...
  ["nvim-compe"] = {
    loaded = true,
    path = "/home/michael/.config/local/share/nvim/site/pack/packer/start/nvim-compe"
  },
  ["nvim-lspconfig"] = {
    loaded = true,
  ...
  ["plenary.nvim"] = {
    loaded = true,
    path = "/home/michael/.config/local/share/nvim/site/pack/packer/start/plenary.nvim"
  },
  ["popup.nvim"] = {
    loaded = true,
    path = "/home/michael/.config/local/share/nvim/site/pack/packer/start/popup.nvim"
  },
  ["telescope.nvim"] = {
    loaded = true,
    path = "/home/michael/.config/local/share/nvim/site/pack/packer/start/telescope.nvim"
  },
  vim = {
    loaded = true,
